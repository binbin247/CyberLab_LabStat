...
- 时间窗口：`2026-07-29 12:00` 至 `2026-07-30 12:00`
- 发布类型：完整双设备发布
- 设备覆盖：`106-设备区`（外间）、`106-testing 5`（内间）
- 离线设备：无
- 数据范围：外间 `2026-07-29 12:05:01` 至 `2026-07-30 11:49:58`；内间 `2026-07-29 12:00:05` 至 `2026-07-30 11:57:52`
- 状态：`正常`
- 判定规则：当前规则，温度 `20–25 °C`、湿度 `35–60 %RH`，单项累计超限严格超过 `2 小时` 才判定不正常

![2026-07-29 至 2026-07-30 温湿度图](figures/temperature_humidity_2026-07-29-12-00-00_to_2026-07-30-12-00-00.png)

> 实验室温湿度监测：正常。

[查看外间 CSV](<data/raw/106-设备区_raw_2026-07-29-12-00-00_to_2026-07-30-12-00-00.csv>) | [查看内间 CSV](<data/raw/106-testing 5_raw_2026-07-29-12-00-00_to_2026-07-30-12-00-00.csv>) | [查看状态报告](reports/lab_status_2026-07-29-12-00-00_to_2026-07-30-12-00-00.md)
...
[查看温湿度图](figures/temperature_humidity_2026-07-29-12-00-00_to_2026-07-30-12-00-00.png) | [查看状态报告](reports/lab_status_2026-07-29-12-00-00_to_2026-07-30-12-00-00.md)
